...
public class IPv4Address implements HostName {
	...
	private static final String REGEXPATTERN = "^" + BYTEREGEX + "\\." + BYTEREGEX + "\\." + BYTEREGEX + "\\."
			+ BYTEREGEX + "$";
	...
	public IPv4Address(final long address) {
		if (address < 0 || address > MAX_IPV4) {
			throw new IllegalArgumentException(
					address + " is not in the range of a valid IPv4 address. 0 to " + String.valueOf(MAX_IPV4));
		}
	 ...
	 * 
	 * @param parsable the string to parse
