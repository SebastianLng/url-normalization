...
public class URL {
	...
	/**
	 * Returns a {@link URI} representation of this object or null when not valid.
	 * All fragments will be removed from the original URL.
	 * 
	 * @return the uri
	...
	public String getRepairedUrl() {
		return this.scheme + "://" + this.authority.getAsString() + this.path.getReEncoded().getAsString()
				+ this.query.getAsString(true, false) + (this.fragment == null ? "" : "#" + this.fragment);
	}

	public String getNormalizedUrl() {
		return this.authority.getOptimizedForProximityOrder() + this.path.getReEncoded().getAsString()
				+ this.query.getAsString(true, true);
	}
