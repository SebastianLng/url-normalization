...
public class URLTest {
	...
	public void testGetGivenInputUrl() {
		...
		assertEquals("http://www.domain.com/test/path.php?val=12&a=15&x=10",
				this.urlWithUnsortedQuery.getGivenInputUrl());
		assertEquals("http://www.domain.com/te st/path.php?val=12&a=15&x=10",
				this.urlWithUnsortedQueryAndSpace.getGivenInputUrl());
		assertEquals("http://user:pass@www.domain.com/test/path.php?val=12&a=15&x=10",
				this.urlWithUserAndPass.getGivenInputUrl());
		assertEquals("https://www.domain.com/test/path.php?val=12&a=15&x=10#4",
				this.urlWithHttpsSchemaAndFragment.getGivenInputUrl());
		assertEquals("http://www.domain.com/test/path/?val=12&a=15&x=10",
				this.urlWithTrailingSlashInPathAndQuery.getGivenInputUrl());
	}
	...
	public void testGetNormalizedUrl() {
		...
		assertEquals("com.domain/te+st/path.php?a=15&val=12&x=10",
				this.urlWithUnsortedQueryAndSpace.getNormalizedUrl());
		assertEquals("com.domain/test/path.php?a=15&val=12&x=10", this.urlWithUserAndPass.getNormalizedUrl());
		assertEquals("com.domain/test/path?a=15&val=12&x=10",
				this.urlWithTrailingSlashInPathAndQuery.getNormalizedUrl());
	}
	...
	public void testGetRepairedUrl() {
		...
		assertEquals("http://www.domain.com/test/path.php?val=12&a=15&x=10",
				this.urlWithUnsortedQuery.getRepairedUrl());
		assertEquals("http://www.domain.com/te+st/path.php?val=12&a=15&x=10",
				this.urlWithUnsortedQueryAndSpace.getRepairedUrl());
		assertEquals("http://user:pass@www.domain.com/test/path.php?val=12&a=15&x=10",
				this.urlWithUserAndPass.getRepairedUrl());
		assertEquals("https://www.domain.com/test/path.php?val=12&a=15&x=10#4",
				this.urlWithHttpsSchemaAndFragment.getRepairedUrl());
		assertEquals("http://www.domain.com/test/path?val=12&a=15&x=10",
				this.urlWithTrailingSlashInPathAndQuery.getRepairedUrl());
	}
	...
	public void getUriShouldRemoveAllFragments() throws URISyntaxException, MalformedURLException {
		try {
			final URI uri = new URL(
					"http://www.spiegel.de/sport/fussball/0,1518,558100,00.html#BLREL-1124499-1-2010/11#ref=rss")
							.getURI();
	...
	@Test
	public void getUriShouldNotThrowEceptionWhenUrlContainsMoreThanOneFragment()
			throws URISyntaxException, MalformedURLException {
		try {
			final URI uri = new URL(
					"http://www.spiegel.de/sport/fussball/0,1518,558100,00.html#BLREL-1124499-1-2010/11#ref=rss#article_38873#feed_383882")
							.getURI();
			assertNull(uri.getFragment());
		} catch (final URISyntaxException e) {
	...
	@Test
	public void getUriShouldNotThrowEceptionWhenUrlContainsOneFragment()
			throws URISyntaxException, MalformedURLException {
		try {
			final URI uri = new URL(
					"http://www.spiegel.de/sport/fussball/0,1518,558100,00.html#BLREL-1124499-1-2010/11").getURI();
			assertNull(uri.getFragment());
		} catch (final URISyntaxException e) {
	...
	@Test
	public void getUriShouldNotThrowEceptionWhenUrlContainsNoFragment()
			throws URISyntaxException, MalformedURLException {
		try {
