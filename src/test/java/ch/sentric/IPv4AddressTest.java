...
public class IPv4AddressTest {
	...
	public void testParseOutOfRangeIPv4AddressFails() {
		runFailingParseTests(new String[] { "256.11.12.10", "10.256.12.13", "10.11.256.13", "10.11.12.256",
				"356.11.12.10", "10.356.12.13", "10.11.356.13", "10.11.12.356" });
	}
	...
	private void runFailingParseTests(final String[] cases) {
		for (final String c : cases) {
			...
			assertEquals("String: <" + c + "> did not fail, gave " + parseResult, IPv4Address.ILLEGAL_IPV4,
					parseResult);
		}
	}
}
